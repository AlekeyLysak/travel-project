  ...
  return (
     <Swiper className='swiper'
      ...
      onSlideChange={() => console.log('slide change')}>
        ...
        <SwiperSlide>
           <img src='https://wallpaperaccess.com/full/6957281.jpg' alt="Falls" style={{ height: "100vh", width: '100%', objectFit: 'cover' }} /></SwiperSlide>
        <SwiperSlide>
        ...
        <SwiperSlide>
           <img src='https://r4.wallpaperflare.com/wallpaper/499/529/311/cliff-waterfall-tropical-rock-wallpaper-4970883dc11a6dcbd627e81f10e1763d.jpg' alt="Falls" style={{ height: "100vh", width: '100%', objectFit: 'cover' }} /></SwiperSlide>
        <SwiperSlide>
           <img src='https://images3.alphacoders.com/807/807167.jpg' alt="Falls" style={{ height: "100vh", width: '100%', objectFit: 'cover' }} /></SwiperSlide>
        <SwiperSlide>
           <img src='https://r4.wallpaperflare.com/wallpaper/203/302/519/morning-africa-national-park-arusha-national-park-wallpaper-6900781d610a5d0ba60738ef80e1b64d.jpg' alt="Falls" style={{ height: "100vh", width: '100vw', objectFit: 'cover' }} /></SwiperSlide>
        <SwiperSlide>
           <img src='https://r4.wallpaperflare.com/wallpaper/506/581/200/namibia-desert-nature-landscape-wallpaper-7211c220cd064e7b0a88c255e0988942.jpg' alt="Falls" style={{ height: "100vh", width: '100%', objectFit: 'cover' }} /></SwiperSlide>
        <SwiperSlide>
        ...
        <SwiperSlide>
           <img src='https://r4.wallpaperflare.com/wallpaper/30/695/708/sea-sunset-photo-dawn-wallpaper-277414528ec641accdd29b26825a11b0.jpg' alt="Falls" style={{ height: "100vh", width: '100%', objectFit: 'cover' }} /></SwiperSlide>
      </Swiper>
   )
}
